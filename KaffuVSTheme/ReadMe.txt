...
This is my personal Visual Studio theme, based on the blue color because it's my favorite color. I hope you like it!

## Preview 📷

![Preview](https://storage.googleapis.com/kaffu-theme/Images/KaffuVSThemePreview.png)
...
- [Visual Studio Theme Converter](https://github.com/microsoft/theme-converter-for-vs) to convert the theme from Visual Studio Code.

## Use 🚀

### Through the Visual Studio Marketplace 📦

- Open the [Visual Studio Marketplace](https://marketplace.visualstudio.com/vs) and search for `Kaffu's Theme`.
- Click on the `Download` button.
- Go to `Tools > Options > Environment > General` and select `Kaffu Theme` in the `Color theme` dropdown.

### Through the VSIX File 📦

- Download the [.vsix](https://github.com/Kaffu093/KaffuVSTheme/releases) from the releases section.
...
- Go to the [issues](https://github.com/Kaffu093/KaffuVSTheme/issues) section.
